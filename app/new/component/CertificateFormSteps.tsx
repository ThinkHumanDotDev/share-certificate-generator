...
export const CertificateFormSteps = () => {
...
const step1 = {
  previous: null,
  nextStep: { title: "Shareholder Details", step: "2" },
};

const step2 = {
  previous: { title: "Company Details", step: "1" },
  nextStep: { title: "Share Details", step: "3" },
};

const step3 = {
  previous: { title: "Shareholder Details", step: "2" },
  nextStep: { title: "Signatories", step: "4" },
};

const step4 = {
  previous: { title: "Share Details", step: "3" },
  nextStep: { title: "Appearance", step: "5" },
};

const step5 = {
  previous: { title: "Signatories", step: "4" },
  nextStep: { title: "Review & Download", step: "6" },
};

const step6 = {
  previous: { title: "Appearance", step: "5" },
  nextStep: null,
};
